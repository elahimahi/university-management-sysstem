<?php
/**
 * Get Faculty's Students and Their Enrollments for Grading
...
try {
    ...
    // Format data grouped by course
    $courseGrouped = [];
    foreach ($students as $student) {
        $course_key = $student['course_id'];
        if (!isset($courseGrouped[$course_key])) {
            $courseGrouped[$course_key] = [
        ...
        $courseGrouped[$course_key]['students'][] = [
    ...
    echo json_encode([
        'status' => 'success',
        'courses' => array_values($courseGrouped),
