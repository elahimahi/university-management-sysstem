                        ...
                        <header className="mb-12 flex justify-between items-end">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    {lastUpdated && (
                                        <p className="text-xs text-gray-500 flex items-center gap-1">
                                            ...
                                            {isRefreshing ? 'Updating...' : `Updated ${Math.floor((new Date().getTime() - lastUpdated.getTime()) / 1000)}s ago`}
                                        </p>
                                    )}
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2.5 bg-gold-500/10 hover:bg-gold-500/20 text-gold-400 border border-gold-500/20 rounded-xl font-semibold transition-all hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
