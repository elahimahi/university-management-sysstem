...
const Topbar = () => {
  ...
  return (
    <header className="w-full bg-white dark:bg-gray-800 shadow flex items-center justify-between px-6 py-3">
      <div className="font-bold text-lg text-blue-600 dark:text-blue-300">Dashboard</div>
